...
(function(r) {
    ...
    function aa(a, c, d) {
        ...
        for (j = 0; t = c[j]; j++) {
            ...
            if (d && (!k || k.indexOf("/") !== 0 && k.indexOf(":") === -1))
                k = d + "/" + (k || t.name);
            a[t.name] = {name: t.name, location: k ||
    ...
    function ga(a) {
        ...
        function p(b) {
            ...
            if (c && K(c)) {
                ...
                if (e)
                    (c = b.cjsModule) && c.exports !== r && c.exports !== n[e] ? g = n[e] = b.cjsModule.exports : g === r && b.usingExports ? g = n[e] : (n[e] = g, H[e] && (T[e] = !0))
            } else
                e && (g = n[e] = c, H[e] && (T[e] = !0));
            if (x[b.id])
        ...
        function v(b, f) {
            ...
            g && (h = M[g]);
            if (!h && (e = !0, h = {id: (a && !c ? O++ + "__p@:" : "") + (g || "__r@" + O++), map: b,
                depCount: 0, depDone: [], depCallbacks: [], deps: [], listeners: [], add: D}, B[h.id] = !0, g && (!a || N[a])))
                M[g] = h;
        ...
        function C(b, f, a, c) {
            ...
            for (a = 0; a < f.length; a++)
                if (j = f[a])
                    j = l(j, d ? b : c), o = j.fullName, f[a] = o, o === "require" ? k[a] = t(b) : o === "exports" ? (k[a] = n[h] = {}, e.usingExports = !0) : o === "module" ? e.cjsModule = k[a] = {id: d, uri: d ? i.nameToUrl(d, null, c) : r, exports: n[h]} : o in n && !(o in x) && (!(h in H) || h in H && T[o]) ? k[a] = n[o] : (h in H && (H[o] = !0, delete n[o], R[j.url] = !1), e.depCount += 1, e.depCallbacks[a] = u(e, a), v(j, !0).add(e.depCallbacks[a]));
            e.depCount ? y(e) : p(e)
        }
        function w(b) {
            C.apply(null,
            ...
            for (h in s)
                if (!(h in L) && (c = !0, !s[h]))
                    if (b)
                        ...
                        (e = M[h] && M[h].moduleDeps) && k.push.apply(k, e);
            if (!c && !i.waitCount)
                return r;
            if (b && a)
        ...
        var i, A, q = {waitSeconds: 7, baseUrl: "./", paths: {}, pkgs: {}, catchError: {}}, S = [], B = {require: !0, exports: !0, module: !0}, G = {}, n = {}, s = {}, x = {}, J = [], R = {}, O = 0, M = {}, N = {}, H = {}, T = {}, Z = 0;
        W = function(b) {
        ...
        i = {contextName: a, config: q, defQueue: S, waiting: x, waitCount: 0, specified: B, loaded: s, urlMap: G, urlFetched: R, scriptCount: 0, defined: n, paused: [], pausedCount: 0, plugins: N, needFullExec: H, fake: {}, fullExec: T, managerCallbacks: M, makeModuleMap: l, normalize: c, configure: function(b) {
                var a,
                        c, d;
    ...
    var la = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg, ma = /require\(\s*["']([^'"\s]+)["']\s*\)/g, fa = /^\.\//, ba = /\.js$/, O = Object.prototype.toString, u = Array.prototype, ha = u.slice, ja = u.splice, I = !!(typeof window !== "undefined" && navigator && document), da = !I && typeof importScripts !== "undefined", na = I && navigator.platform === "PLAYSTATION 3" ? /^complete$/ : /^(complete|loaded)$/,
            ea = typeof opera !== "undefined" && opera.toString() === "[object Opera]", L = {}, D = {}, U = [], C = null, Y = 0, Q = !1, ia = {require: !0, module: !0, exports: !0}, d, u = {}, J, y, v, E, o, w, F, B, z, W, X;
